...
svn co https://github.com/sirpdboy/sirpdboy-package/tree/main/luci-app-aliddns
svn co https://github.com/sirpdboy/sirpdboy-package/tree/main/luci-app-control-timewol
